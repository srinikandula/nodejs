...
category_type_id = ARGV[1] || '538faa01b37f2af9a6f0ef54'  # localhost ishiki
category_subtype_id = ARGV[1] || '538faa11b37f2af9a6f0ef55'   # localhost ishiki
...
all_data['data'].each do |raw_poi|
  ...
  poi = {
      ...
      :import_src => 'data.cityofnewyork.us-farmers.markets'
  }
